...
from voxing.mimi.modules.conv import StreamableConv1d, StreamableConvTranspose1d
...
class SeanetResnetBlock(nn.Module):
    ...
    def __call__(self, xs: mx.array) -> mx.array:
        ...
        return xs + residual if self.shortcut is None else xs + self.shortcut(residual)
